...
public class RoomServiceBean implements RoomService {
	...
	/* (non-Javadoc)
	 * @see com.prodyna.pac.conference.service.RoomService#createRoom(com.prodyna.pac.conference.model.Room)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.prodyna.pac.conference.service.RoomService#deleteRoom(com.prodyna.pac.conference.model.Room)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.prodyna.pac.conference.service.RoomService#updateRoom(com.prodyna.pac.conference.model.Room)
	 */
	@Override
